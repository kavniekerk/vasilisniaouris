...
enum G4OpBoundaryProcessStatus {  Undefined,
                                  ...
                                  Dichroic, NoThinLayers, ThinLayers};
...
private:
	...
	G4ThreeVector GetFacetNormal(const G4ThreeVector& Momentum,
        ...
        void multiplyComplex(G4complex matrix1[2][2], G4complex matrix2[2][2], G4complex res[2][2]);
...
//-------------------------------my-begin---------------------------------------
    G4int theLayers;
    std::vector<G4double> RindexReal;
    std::vector<G4double> RindexImag;
...
inline
void G4OpBoundaryProcess::multiplyComplex(G4complex matrix1[2][2], G4complex matrix2[2][2], G4complex res[2][2])
{
    int i, j, k;
